        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
            ...
            <div style={{
              ...
              <p style={{ color: 'var(--text2)', fontSize: '0.95rem', lineHeight: 1.72, marginBottom: '1.5rem' }}>
                The thinking partner who knows Africa. Stress-tests your business idea with real African data. Asks the questions no consultant has the context to ask.
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '1.75rem' }}>
                {['VALIDATOR — Stress-test a specific business idea', 'EXPLORER — Discover the right idea through guided questions', 'LEARNER — Deep intelligence on African markets'].map(f => (
