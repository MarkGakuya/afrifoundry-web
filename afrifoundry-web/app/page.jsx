  ...
  return (
    <>
      ...
      <section style={{
        ...
        padding: 'clamp(5rem, 10vw, 9rem) 1.5rem clamp(3rem, 6vw, 5rem)',
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 860 }}>
          ...
          <h1 className="animate-float-delay-1" style={{
            ...
            <span style={{
              background: 'linear-gradient(135deg, #ffffff 0%, rgba(249,115,22,0.95) 55%, #F59E0B 100%)',
          ...
          <p className="animate-float-delay-2" style={{
            ...
            color: 'var(--text2)', maxWidth: 560, margin: '0 auto 0.75rem',
            lineHeight: 1.8,
          }}>
            Every major AI was trained on internet data.
            Less than 2% of that data came from Africa.
            AfriFoundry is building what was left out.
          </p>
          <p className="animate-float-delay-3" style={{
            fontSize: 'clamp(0.95rem, 2vw, 1.05rem)',
            color: 'rgba(255,255,255,0.6)', maxWidth: 480, margin: '0 auto 2.5rem',
            lineHeight: 1.7, fontStyle: 'italic',
          }}>
            Data. Intelligence. Infrastructure. Built from the inside.
          </p>
            ...
            {[
              ...
              <div key={s.label} style={{ textAlign: 'center' }}>
                <div style={{
                  ...
                  color: 'var(--orange)', lineHeight: 1, marginBottom: '0.2rem',
                }}>{s.num}</div>
        ...
        <div style={{
          ...
          flexDirection: 'column', alignItems: 'center', gap: '0.4rem', opacity: 0.5,
        }}>
      ...
      <div style={{
        ...
        borderBottom: '1px solid var(--border)', padding: '0.7rem 0', overflow: 'hidden',
      }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center' }}>
            <div>
              ...
              <h2 style={{ fontFamily: 'var(--font-syne)', fontWeight: 800, fontSize: 'clamp(1.8rem,4vw,2.8rem)', lineHeight: 1.12, letterSpacing: '-0.02em', marginBottom: '1.25rem' }}>
                Africa has been building on{' '}
                <em style={{ fontStyle: 'normal', color: 'var(--orange)' }}>borrowed intelligence</em>
              </h2>
              ...
              <div style={{
                ...
                borderLeft: '3px solid var(--orange)', borderRadius: '0 10px 10px 0', padding: '1rem 1.25rem',
              }}>
            ...
            <div style={{
              ...
              <p style={{ color: 'var(--text2)', fontSize: '0.95rem', lineHeight: 1.72, marginBottom: '1.5rem' }}>
                Bloomberg Terminal became the world's most trusted financial intelligence platform by owning the data layer. AfriFoundry is doing the same for Africa — starting with ground-truth market intelligence nobody else has collected.
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                {[
                  { label: 'V1 — Now', text: 'AfriFoundry AI — thinking partner for every African', live: true },
                  { label: 'V2 — Q3 2026', text: 'Fine-tuned African AI model — trained on our own data' },
                  { label: 'V3 — Q4 2026', text: 'The Network — AI that finds customers and matches markets' },
                  { label: 'V4 — 2027+', text: 'The African Intelligence Layer — API for the continent' },
                ].map(v => (
                  <div key={v.label} style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                    ...
                    {v.live && <span style={{ width: 5, height: 5, background: 'var(--green)', borderRadius: '50%', flexShrink: 0, marginTop: '0.35rem' }} />}
                  </div>
                ))}
              </div>
            </div>
      ...
      <section style={{ padding: '6rem 1.5rem', background: 'var(--bg)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            ...
            <p style={{ color: 'var(--text3)', fontFamily: 'var(--font-jetbrains)', fontSize: '0.7rem', letterSpacing: '0.08em', marginTop: '0.75rem' }}>
              AfriFoundry AI is Product 01 · More products are being built on this infrastructure
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
            ...
            <div style={{
              ...
              <h3 style={{ fontFamily: 'var(--font-syne)', fontWeight: 800, fontSize: '1.6rem', marginBottom: '0.75rem' }}>AfriFoundry AI</h3>
              <p style={{ color: 'var(--text2)', fontSize: '0.95rem', lineHeight: 1.72, marginBottom: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '1.75rem' }}>
                {[
                  'Entrepreneur — validate your idea with real KES numbers before risking your savings',
                  'Student — career paths, HELB, and what the job market actually looks like',
                  'Farmer — planting seasons, input costs, when to sell. County and crop specific.',
                  'Driver & Transport — vehicle economics, SACCO financing, route profitability',
                  'Mwananchi — any consequential decision, any context. Africa knows.',
                ].map(f => (
                  <div key={f} style={{ display: 'flex', gap: '0.65rem', alignItems: 'flex-start', fontSize: '0.85rem', color: 'var(--text2)' }}>
                    <span style={{ color: 'var(--green)', fontWeight: 700, flexShrink: 0, marginTop: '0.1rem' }}>✓</span>{f}
                  </div>
                ))}
              </div>
            ...
            <div style={{
              ...
              <h3 style={{ fontFamily: 'var(--font-syne)', fontWeight: 800, fontSize: '1.6rem', marginBottom: '0.75rem' }}>The AfriFoundry Dataset</h3>
              <p style={{ color: 'var(--text2)', fontSize: '0.95rem', lineHeight: 1.72, marginBottom: '1.5rem' }}>
            ...
            <div style={{
              ...
              <h3 style={{ fontFamily: 'var(--font-syne)', fontWeight: 800, fontSize: '1.6rem', marginBottom: '0.75rem' }}>AfriScout</h3>
              <p style={{ color: 'var(--text2)', fontSize: '0.95rem', lineHeight: 1.72, marginBottom: '1.5rem' }}>
      ...
      <section style={{ padding: '5rem 1.5rem', background: 'var(--bg2)', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse 50% 60% at 50% 50%, rgba(249,115,22,0.05) 0%, transparent 70%)', pointerEvents: 'none' }} />
        <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1.25rem' }}>
            {[
              ...
              { n: '38', l: 'Sectors covered', sub: 'across Africa' },
      ...
      <section style={{ padding: '6rem 1.5rem', background: 'var(--bg)' }}>
        <div style={{ maxWidth: 780, margin: '0 auto', textAlign: 'center' }}>
          <div style={{
            ...
            letterSpacing: '0.14em', padding: '0.4rem 1.1rem', borderRadius: 100, marginBottom: '1.75rem',
          }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ color: 'var(--text2)', fontSize: '0.95rem', lineHeight: 1.72, marginBottom: '1.75rem' }}>
              African market realities, data insights, and intelligence — written for every African building something real.
            </p>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '2rem' }}>
              ...
              <span style={{ color: 'var(--text2)', fontSize: '0.9rem' }}>already reading</span>
            </div>
