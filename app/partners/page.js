  ...
  return (
    <section className="py-16 md:py-24">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <a
          href="mailto:partnerships@afrifoundry.com?subject=Partnership%20inquiry"
          className="mt-8 inline-block rounded-md border border-line px-6 py-3 font-semibold"
        >
          Talk to us
        </a>
      </div>
